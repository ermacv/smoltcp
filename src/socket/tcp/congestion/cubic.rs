...
impl Controller for Cubic {
    ...
    fn on_ack(&mut self, now: Instant, len: usize, in_flight: usize, rtt: &RttEstimator) {
        ...
        let c_as_bytes = C * self.mss as f64;
        let delta = t as f64 / 1_000_000.0 - self.k;
        let w_cubic = c_as_bytes * delta * delta * delta + self.w_max as f64;
        ...
        let w_cubic_target = {
            ...
            let delta = t_ahead - self.k;
            let raw = c_as_bytes * delta * delta * delta + self.w_max as f64;
